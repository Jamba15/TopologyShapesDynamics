...
class signal_elaboration:
    ...
    def visualization_plot(self, i1, Gaussian, x_min, lab, ax=None):
        ...
        # Change the title of the plot: if x_min is True, the title is "Smallest positive eigenvalue", otherwise "Largest positive eigenvalue"
        title = "Smallest positive eigenvalue" if x_min else "Largest positive eigenvalue"
        axis1.set_title(title, fontsize=18)
    ...
    def plot_results(self, save_fig, **kwargs):
        ...
        self.visualization_plot(1, False, False, True, ax=axs)
...
class SimplicialComplexConstructor:
    ...
    def draw_graph(self):
        ...
        # Draw the graph with node labels
            plt.title("Simplex from edges", fontsize=20)
            ...
            plt.figure()
            plt.title("Simplex from edges and triangles", fontsize=20)
