...
def Kuramoto_edges(Phi, sigma, B1, B2, Omega):
    """
    This function calculates the time derivative of the edge phases for the simplicial Topological_Kuramoto model  defined on the edges
...
def kuramoto_update(Psi, dt, sigma, B1, B2, Omega):
    """Performs one RK4 update step for the Topological_Kuramoto model."""
...
def kuramoto_integrate_and_plot(Psi0, config, B1, B2, B2b, Omega, create_animation=True):
    ...
    Number_of_filled_cells = config['Number_of_filled_cells']
